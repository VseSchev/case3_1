...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String nazvanie = 'Кейс-задание 3.1 Сохранение и загрузка данных';
    return MaterialApp(
      title: nazvanie,
      home: MyHomePage(title: nazvanie, storage: CounterStorage()),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          ...
          const Text('Счетчик в Shared Preferances:'),
          Text('$_counter_in_sharedprefs',
              style: Theme.of(context).textTheme.headline4),
          ElevatedButton(
              onPressed: _incrementSPCounter,
              child: Text('Увеличить счетчик в Shared Preferances')),
          const Text('Счетчик в File:'),
          Text('$_counter_in_file',
              style: Theme.of(context).textTheme.headline4),
          ElevatedButton(
              onPressed: _incrementFileCounter,
              child: Text('Увеличить счетчик в File')),
        ])));
  }
}
